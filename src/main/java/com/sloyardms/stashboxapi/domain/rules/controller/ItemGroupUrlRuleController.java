...
@Validated
@RequestMapping("/api/v1/item-groups/{groupId}/url-rules")
public class ItemGroupUrlRuleController {
    ...
    public ResponseEntity<UrlRuleDetailResponse> findById(
        ...
        UrlRuleDetailResponse response = urlRuleService.findById(authenticatedUser.id(), groupId, id);
    ...
    public ResponseEntity<List<UrlRuleSummaryResponse>> findByDomain(
        ...
        List<UrlRuleSummaryResponse> response = urlRuleService.searchByGroupAndDomain(authenticatedUser.id(), groupId,
                domain);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<UrlRuleDetailResponse> create(
        ...
        UrlRuleDetailResponse response = urlRuleService.create(authenticatedUser.id(), groupId, createUrlRuleRequest);
    ...
    public ResponseEntity<UrlRuleDetailResponse> patch(
        ...
        UrlRuleDetailResponse response = urlRuleService.patch(authenticatedUser.id(), groupId, id, body);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<Void> delete(
        ...
        urlRuleService.delete(authenticatedUser.id(), groupId, id);
    ...
    public ResponseEntity<Void> updateMatched(
        ...
        urlRuleService.updateLastMatched(authenticatedUser.id(), groupId, id);
        return ResponseEntity.noContent().build();
    }
